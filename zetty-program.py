...
class Ui_MainWindow(QWidget):
    def setupUi(self, MainWindow):
        ...
        self.ZETTY = QtWidgets.QLabel(self.centralwidget)
        self.ZETTY.setGeometry(QtCore.QRect(250, 0, 241, 31))
        self.ZETTY.setObjectName("ZETTY")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "제티식 프로그램"))
        self.ZETTY.setText(_translate("MainWindow", "제작자 : 윤제티     ▶ zetty123@naver.com"))
